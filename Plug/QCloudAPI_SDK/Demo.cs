...
namespace QCloudAPI_SDK
{
    class Demo
    {
        static void Main(string[] args)
        {
		    ...
		    config["SecretId"] = "AKIDGMDpBHCoFQL2WmPIDuMZXFhy2qTtFxb3";
		    config["SecretKey"] = "KQGqCJAk49xVnoa6uTlnYbnlTv9AwTlw";
	    ...
	    //requestParams["SignatureMethod"] = "HmacSHA256";
            ...
            Console.WriteLine(module.Call("CreateClass", requestParams));
