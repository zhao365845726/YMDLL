...
namespace ERP3ToOBS
{
    public class Base
    {
        ...
        /// 连接SQL_SERVER的数据库对象
        /// </summary>
        public YM_SQLServer _dsqlserver;
        /// <summary>
        /// 时间计算对象
        /// </summary>
        ...
        public Base()
        {
            ...
            _dsqlserver.dbInitialization(ReadAppSetting("DestName"), ReadAppSetting("DestDB"),ReadAppSetting("DestUserName"),ReadAppSetting("DestPassword"));
            sWhere = "1=1";
            ...
            dCityName = ReadAppSetting("DestCityName");
            dDeleteMark = "0";
        ...
        {
            _dsqlserver.dbUpdateField("add", dTableName, FieldName, FieldType);
            m_Result = _dsqlserver.ErrorMessage;
        }
        ...
        {
            _dsqlserver.dbUpdateField("modify column ", dTableName, FieldName, FieldType);
            m_Result = _dsqlserver.ErrorMessage;
        }
        ...
        {
            _dsqlserver.dbUpdateField("drop ", dTableName, FieldName, "");
            m_Result = _dsqlserver.ErrorMessage;
        }
        #endregion
        ...
        {
            string strsql = "select MarkId from zhCity where Name = '" + cityname + "'";
            DataSet ds = _dsqlserver.dbReadData(strsql);
