...
namespace HzlyToERP3_PHP
{
    public class ta_Dstrict : Base
    {
        ...
        public Dictionary<string, string> FieldMap()
        {
            ...
            dicMap.Add("district_name", "dstrictname");
            dicMap.Add("if_deleted", ":String?Default=" + dDeleteMark);
            dicMap.Add("longitude", "lngx");
            dicMap.Add("latitude", "laty");
            dicMap.Add("status", ":String?Default=0");
            dicMap.Add("create_time", ":String?Default=" + dDefaultTime);
            dicMap.Add("update_time", ":String?Default=" + dDefaultTime);
            dicMap.Add("erp_id", "dsid");
            return dicMap;
        }
        ...
        public ta_Dstrict()
        {
            sTableName = "ta_dstrict";
            sColumns = CombineSourceField(FieldMap());
            sOrder = "areaid,districtno";
