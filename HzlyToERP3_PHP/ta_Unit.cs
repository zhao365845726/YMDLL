...
namespace HzlyToERP3_PHP
{
    public class ta_Unit : Base
    {
        ...
        public Dictionary<string, string> FieldMap()
        {
            ...
            dicMap.Add("unit_code", "unitname");
            dicMap.Add("unit_suffix", ":String?Default=单元");
            dicMap.Add("create_time", "createtime:DateTime");
            dicMap.Add("update_time", "createtime:DateTime");
            dicMap.Add("status", ":String?Default=0");
            dicMap.Add("total_house_num", ":String?Default=0");
            dicMap.Add("lifts", ":String?Default=2");
            dicMap.Add("rooms", ":String?Default=4");
            dicMap.Add("start_room_code", ":String?Default=1");
            dicMap.Add("total_floor_num", ":String?Default=10");
            dicMap.Add("if_deleted", ":String?Default=" + dDeleteMark);
            dicMap.Add("check_status", ":String?Default=0");
            dicMap.Add("company_id", ":String?Default=" + dCompanyId);
            dicMap.Add("rooms_alias_json", ":String?Default=");

            //新增字段
            dicMap.Add("old_unitid", "unitid");
        ...
        public ta_Unit()
        {
            sTableName = "ta_buildingunit";
            sColumns = CombineSourceField(FieldMap());
            sOrder = "createtime";
            dTableName = "erp_community_unit";
            dTableDescript = "单元表";
